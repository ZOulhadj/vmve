...
//
//        ImGui::Checkbox("EntityInstance overlay", &overlay);
//
//        ImGui::End();
//    }
//
...
//        glm::vec2 sun_screen_pos = WorldToScreen(sun_pos);
//        glm::vec2 earth_screen_pos = WorldToScreen(earth_pos);
//        glm::vec2 moon_screen_pos = WorldToScreen(moon_pos);
//
//        static bool o = true;
//
