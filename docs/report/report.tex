...
is known as perspective projection \cite{3d_projection}. Figure
\ref{fig:mvp_projection} shows the calculation that performs this
transformation. \(P\) is a 4x4 matrix that stores the projection. \(V\)
