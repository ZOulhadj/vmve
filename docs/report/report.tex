...
rendering application designed for creating virtual environments. The goal of
...
This report will discuss projects development from beginning
to end. The report is structured such that it outlines each aspect of the
project in the order that it happened. There are a total of five key sections to
this report. The introduction, design, implementation, evaluation and finally,
future work.
...
The \gls{vmve} project was also officially approved by my supervisors
