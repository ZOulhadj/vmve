...
% back this up with data/from a paper
...
groups in order to ensure their requirements and concerns are being taken into
account so that informed decisions can be made during development.
...
employees in the field of computer graphics.
